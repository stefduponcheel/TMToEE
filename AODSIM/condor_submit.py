...
def submit_jobs():
    ...
    mode = "etaToTMGamma"
    njobs = 2
    indir = f"/store/user/sduponch/PhD/TMToEE/{mode}/20260423/Simulation/SIM/{year}/260423_154145/0000"
    outdir = f"/store/user/sduponch/PhD/TMToEE/{mode}/{ver}/Simulation/AODSIM/{year}"

    os.makedirs("./tmp", exist_ok=True)
    # 1-indexed job IDs and per-job subdirs
...
log    = /afs/cern.ch/user/s/sduponch/private/PhD/TM/TMToEE/CMSSW_12_4_14_patch3/src/AODSIM/tmp/job_$(jobid)/job_$(jobid).log
output = /afs/cern.ch/user/s/sduponch/private/PhD/TM/TMToEE/CMSSW_12_4_14_patch3/src/AODSIM/tmp/job_$(jobid)/job_$(jobid).out
error  = /afs/cern.ch/user/s/sduponch/private/PhD/TM/TMToEE/CMSSW_12_4_14_patch3/src/AODSIM/tmp/job_$(jobid)/job_$(jobid).err
