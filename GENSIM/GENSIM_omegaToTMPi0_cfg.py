...
# with command line options: Configuration/GenProduction/python/omegaToTMPi0_fragment_cff.py --python_filename GENSIM_omegaToTMPi0_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout output.root --conditions 124X_mcRun3_2022_realistic_v12 --beamspot Realistic25ns13p6TeVEarly2022Collision --step GEN,SIM --geometry DB:Extended --era Run3 --no_exec --mc
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/omegaToTMPi0_fragment_cff.py nevts:1'),
...
process.omegaFilter = cms.EDFilter("MCSingleParticleFilter",
...
process.generator = cms.EDFilter("Pythia8ConcurrentGeneratorFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            '223:onMode = off',
            '223:addChannel = on 1 0 111 4900022'
        ),
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.omegaFilter)
