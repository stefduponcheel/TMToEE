...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/B0ToKstarTM_fragment_cff.py nevts:1'),
...
process.bMesonFilter = cms.EDFilter("MCSingleParticleFilter",
...
process.generator = cms.EDFilter("Pythia8ConcurrentGeneratorFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            '511:onMode = off',
            '511:addChannel = on 1 0 313 4900022'
        ),
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.bMesonFilter)
