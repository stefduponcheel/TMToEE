...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/DplusToPiplusTM_fragment_cff.py nevts:1'),
...
process.dMesonFilter = cms.EDFilter("MCSingleParticleFilter",
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.dMesonFilter)
