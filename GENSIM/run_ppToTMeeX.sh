...
echo "Proxy valid"
cmsRun "/afs/cern.ch/user/s/sduponch/private/PhD/TM/TMToEE/CMSSW_12_4_14_patch3/src/GENSIM/GENSIM_ppToTMeeX_cfg.py" "${SKIPEVENTS}" "${EVENTSPERJOB}" "root://eosuser.cern.ch/${outfile}"
