...
def main():
    ...
    #     # electron kinematics
    #     ("ele1_pt",  np.linspace(0, 25, 200),    r"$e_{1}$ $p_{\mathrm{T}}$ [GeV]", "common_ele1_pt"),
    #     ("ele1_pt",  np.linspace(0, 25, 200),    r"$e_{1}$ $p_{\mathrm{T}}$ [GeV]", "common_ele1_pt_log", True),
    #     ("ele2_pt",  np.linspace(0, 25, 200),    r"$e_{2}$ $p_{\mathrm{T}}$ [GeV]", "common_ele2_pt"),
